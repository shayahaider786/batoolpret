                            ...
                            @foreach ($cartItems as $cartItem)
                                ...
                                <div class="cart-item">
                                    ...
                                    <div class="cart-item-details">
                                        <h3 class="cart-item-name">{{ $product ? $product->name : 'Product Not Available' }}
                                        </h3>
                                        @if ($cartItem->size)
                                        ...
                                        <div class="cart-item-mobile-actions">
                                            <div class="quantity-selector">
                                                ...
                                                <input type="number" class="qty-input"
                                                    ...
                                                    data-price="{{ $cartItem->price }}" data-cart-id="{{ $cartItem->id }}"
                                                    readonly>
                                            ...
                                            <a href="{{ route('cart.remove', $cartItem->id) }}" class="remove-item-btn"
                                    ...
                                    <div class="cart-item-quantity">
                                        <div class="quantity-selector">
                                            ...
                                            <input type="number" class="qty-input" name="quantities[{{ $cartItem->id }}]"
                                                value="{{ $cartItem->quantity }}" min="1"
                                                max="{{ $product ? $product->stock : 1 }}"
                                                data-price="{{ $cartItem->price }}" data-cart-id="{{ $cartItem->id }}"
                                                readonly>
                                    ...
                                    <div class="cart-item-total">
                                        <p class="item-total-price" data-cart-id="{{ $cartItem->id }}">Rs.
                    ...
                    <div class="cart-summary-wrapper">
                        <div class="cart-summary">
                            ...
                            <div class="summary-row">
                                ...
                                <span class="summary-value" id="cart-subtotal">Rs.
        ...
        <script defer>
            ...
            $(document).ready(function() {
                ...
                $('input[name^="quantities"]').on('change', function() {
                    ...
                    $('.item-total-price[data-cart-id="' + cartId + '"]').text('Rs. ' + total.toLocaleString(
                        'en-US', {
                ...
                function updateCartTotals() {
                    ...
                    $('#cart-subtotal').text('Rs. ' + subtotal.toLocaleString('en-US', {
                        maximumFractionDigits: 0
                    }));
                    $('#cart-total').text('Rs. ' + subtotal.toLocaleString('en-US', {
                        maximumFractionDigits: 0
                    }));
                }
