                        ...
                        <form action="{{ route('admin.sliders.update', $slider->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        @if($slider->website_slider_image)
                                            <div class="mb-3">
                                                ...
                                                <p class="text-muted mt-2">Current Website Image</p>
                                            </div>
                                        @endif
                                        <input type="file" 
                                        ...
                                        <div id="website-image-preview" class="mt-3" style="display: none;">
                                            ...
                                            <p class="text-muted mt-2">New Website Image Preview</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        @if($slider->mobile_slider_image)
                                            <div class="mb-3">
                                                <img src="{{ asset($slider->mobile_slider_image) }}" 
                                                     ...
                                                     style="max-width: 200px; max-height: 300px; border-radius: 4px; border: 1px solid #ddd;">
                                                <p class="text-muted mt-2">Current Mobile Image</p>
                                            </div>
                                        @endif
                                        <input type="file" 
                                        ...
                                        <div id="mobile-image-preview" class="mt-3" style="display: none;">
                                            ...
                                            <p class="text-muted mt-2">New Mobile Image Preview</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="d-flex justify-content-end">
                                ...
                                <button type="submit" class="btn btn-primary">
                                    <i class="mdi mdi-content-save"></i> Update Slider
                                </button>
                            </div>
                        </form>
                    </div>
