                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <h4 class="card-title mb-0">Add New Best Seller Video</h4>
                        ...
                        <form action="{{ route('admin.best-seller-videos.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" 
                                       ...
                                       accept="video/*"
                                       required>
                                <small class="form-text text-muted">Upload video (MP4, AVI, MOV, WMV, FLV, WEBM - Max: 50MB)</small>
                                @error('video')
                                ...
                                <div id="video-preview" class="mt-3" style="display: none;">
                                    ...
                                    <p class="text-muted mt-2">Video Preview</p>
                                </div>
                            </div>
                            ...
                            <div class="d-flex justify-content-end">
                                ...
                                <button type="submit" class="btn btn-primary">
                                    <i class="mdi mdi-content-save"></i> Create Video
                                </button>
                            </div>
                        </form>
                    </div>
