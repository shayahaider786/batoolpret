                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.categories.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <small class="form-text text-muted">Select a parent category to create a subcategory, or
                                    leave empty to create a main category.</small>
                                @error('parent_id')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group">
                                ...
                                <input type="url" class="form-control @error('category_link') is-invalid @enderror"
                                    id="category_link" name="category_link" value="{{ old('category_link') }}"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <small class="form-text text-muted">Upload category image (JPG, PNG, GIF, WEBP -
                                            Max: 2MB). Images will be converted to WebP format.</small>
                                        @error('image')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <small class="form-text text-muted">Upload banner image (JPG, PNG, GIF, WEBP - Max:
                                            2MB). Images will be converted to WebP format.</small>
                                        @error('banner_image')
                                            <span class="invalid-feedback d-block" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
