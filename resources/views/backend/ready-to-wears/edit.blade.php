                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <h4 class="card-title mb-0">Edit Ready To Wear</h4>
                        ...
                        <form action="{{ route('admin.ready-to-wears.update', $readyToWear->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                                ...
                                @if($readyToWear->image)
                                    <div class="mb-3">
                                        <img src="{{ asset($readyToWear->image) }}" 
                                             alt="Current Image" 
                                             style="max-width: 300px; max-height: 300px; border-radius: 4px; border: 1px solid #ddd;">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" 
                                       ...
                                       id="title" 
                                       name="title" 
                                       value="{{ old('title', $readyToWear->title) }}" 
