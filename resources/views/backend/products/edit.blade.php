                        ...
                        <form action="{{ route('admin.products.update', $product->id) }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('short_description') is-invalid @enderror" id="short_description"
                                    name="short_description" rows="3" placeholder="Enter short description (max 500 characters)">{{ old('short_description', $product->short_description) }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('long_description') is-invalid @enderror" id="long_description"
                                    name="long_description" rows="6" placeholder="Enter detailed product description">{{ old('long_description', $product->long_description) }}</textarea>
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('tag') is-invalid @enderror" id="tag"
                                            ...
                                            <option value="new_arrival"
                                                {{ old('tag', $product->tag) == 'new_arrival' ? 'selected' : '' }}>New
                                                Arrival</option>
                                            <option value="best_selling"
                                                {{ old('tag', $product->tag) == 'best_selling' ? 'selected' : '' }}>Best
                                                Selling</option>
                                            <option value="trending"
                                                {{ old('tag', $product->tag) == 'trending' ? 'selected' : '' }}>Trending
                                            </option>
                                        </select>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <small class="form-text text-muted">
                                            @if ($product->sku)
                                                Current SKU: <strong>{{ $product->sku }}</strong>. Leave empty to keep
                                                current SKU.
                                            @else
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <small class="form-text text-muted">
                                            @if ($product->slug)
                                                Current slug: <strong>{{ $product->slug }}</strong>. Leave empty to
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            id="outfit_type" name="outfit_type"
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('includes') is-invalid @enderror" id="includes" name="includes"
                                    rows="3" placeholder="e.g., 1 x T-Shirt, 1 x Belt, 1 x Gift Box">{{ old('includes', $product->includes) }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('design_details') is-invalid @enderror" id="design_details"
                                    name="design_details" rows="3" placeholder="Enter design details, patterns, or special features">{{ old('design_details', $product->design_details) }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('care_instructions') is-invalid @enderror" id="care_instructions"
                                    name="care_instructions" rows="3" placeholder="e.g., Machine wash cold, Do not bleach, Hang dry">{{ old('care_instructions', $product->care_instructions) }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('disclaimer') is-invalid @enderror" id="disclaimer" name="disclaimer"
                                    rows="3" placeholder="Enter any disclaimers or important notes">{{ old('disclaimer', $product->disclaimer) }}</textarea>
                            ...
                            <div class="form-group">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="embed-responsive embed-responsive-16by9" style="max-width: 560px;">
                                            <iframe class="embed-responsive-item"
                                                ...
                                                allowfullscreen style="width: 100%; height: 315px; border-radius: 4px;">
                                            </iframe>
                                        </div>
                                    </div>
                                @endif
                                <input type="url" class="form-control @error('youtube_link') is-invalid @enderror"
                                    id="youtube_link" name="youtube_link" value="{{ $youtubeLink }}"
                                ...
                                <div id="youtube-preview" class="mt-3" style="display: none;">
                                    ...
                                    <div class="embed-responsive embed-responsive-16by9" style="max-width: 560px;">
                                        <iframe id="youtube-preview-iframe" class="embed-responsive-item" src=""
                                            frameborder="0"
                                            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                            allowfullscreen style="width: 100%; height: 315px; border-radius: 4px;">
                                        </iframe>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('meta_description') is-invalid @enderror" id="meta_description"
                                    ...
                                    placeholder="Enter meta description for SEO (recommended: 150-160 characters)" maxlength="500">{{ old('meta_description', $product->meta_description) }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('meta_tags') is-invalid @enderror"
                                    id="meta_tags" name="meta_tags" value="{{ old('meta_tags', $product->meta_tags) }}"
                            ...
                            <div class="form-group">
                                ...
                                <small class="form-text text-muted">Upload new image to replace current one (JPG, PNG, GIF,
                                    WebP - Max: 2MB). Images will be automatically converted to WebP format.</small>
                                @error('image')
                                    <span class="invalid-feedback d-block" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group">
                                ...
                                @if ($product->size_guide_image)
                                    <div class="mb-3">
                                        <img src="{{ asset($product->size_guide_image) }}" alt="Current Size Guide Image"
                                ...
                                <small class="form-text text-muted">Upload new size guide image to replace current one
                                    (JPG, PNG, GIF, WebP - Max: 2MB). Image will be automatically converted to WebP
                                    format.</small>
