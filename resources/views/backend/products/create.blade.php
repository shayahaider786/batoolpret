                        ...
                        <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                                ...
                                                <div class="col-md-4 mb-2">
                                                    <div class="form-check">
                                                        ...
                                                        <label class="form-check-label" for="category_{{ $category->id }}">
                                                            ...
                                                            @if ($category->parent)
                                                                <small
                                                                    class="text-muted">({{ $category->parent->name }})</small>
                                                            @endif
                                                        </label>
                                                    </div>
                                        ...
                                        <small class="form-text text-muted">Select one or more categories for this
                                            product</small>
                                        @error('categories')
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('short_description') is-invalid @enderror" id="short_description"
                                    name="short_description" rows="3" placeholder="Enter short description (max 500 characters)">{{ old('short_description') }}</textarea>
                                <small class="form-text text-muted">Brief description that will appear in product listings
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('long_description') is-invalid @enderror" id="long_description"
                                    name="long_description" rows="6" placeholder="Enter detailed product description">{{ old('long_description') }}</textarea>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number"
                                            ...
                                            placeholder="0.00">
                                        <small class="form-text text-muted">Discount percent will be calculated
                                            automatically</small>
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('tag') is-invalid @enderror" id="tag"
                                            ...
                                            <option value="new_arrival"
                                                {{ old('tag') == 'new_arrival' ? 'selected' : '' }}>New Arrival</option>
                                            <option value="best_selling"
                                                {{ old('tag') == 'best_selling' ? 'selected' : '' }}>Best Selling</option>
                                            <option value="trending" {{ old('tag') == 'trending' ? 'selected' : '' }}>
                                                Trending</option>
                                        </select>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <small class="form-text text-muted">SKU will be generated automatically if left
                                            empty</small>
                                        @error('sku')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('slug') is-invalid @enderror"
                                            ...
                                            placeholder="Leave empty to auto-generate">
                                        <small class="form-text text-muted">Slug will be generated automatically from
                                            product name if left empty</small>
                                        @error('slug')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" name="size[]"
                                                        value="XXL" id="size_xxl"
                                                        {{ in_array('XXL', old('size', [])) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="size_xxl">XXL</label>
                                                </div>
                                            </div>
                                        </div>
                                        <small class="form-text text-muted">Select one or more sizes available for this
                                            product</small>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            id="outfit_type" name="outfit_type" value="{{ old('outfit_type') }}"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control @error('fabric') is-invalid @enderror" id="fabric" name="fabric" rows="2"
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('includes') is-invalid @enderror" id="includes" name="includes"
                                    rows="3" placeholder="e.g., 1 x T-Shirt, 1 x Belt, 1 x Gift Box">{{ old('includes') }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('design_details') is-invalid @enderror" id="design_details"
                                    name="design_details" rows="3" placeholder="Enter design details, patterns, or special features">{{ old('design_details') }}</textarea>
                                <small class="form-text text-muted">Describe the design, patterns, or special
                                    features</small>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('care_instructions') is-invalid @enderror" id="care_instructions"
                                    name="care_instructions" rows="3" placeholder="e.g., Machine wash cold, Do not bleach, Hang dry">{{ old('care_instructions') }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('disclaimer') is-invalid @enderror" id="disclaimer" name="disclaimer"
                                    rows="3" placeholder="Enter any disclaimers or important notes">{{ old('disclaimer') }}</textarea>
                                <small class="form-text text-muted">Any disclaimers or important information about the
                                    product</small>
                                @error('disclaimer')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                            ...
                            <div class="form-group">
                                ...
                                <small class="form-text text-muted">Optional YouTube video link for the product (e.g.,
                                    product demo, review, etc.)</small>
                                @error('youtube_link')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('meta_title') is-invalid @enderror"
                                    ...
                                    maxlength="255">
                                <small class="form-text text-muted">The title that appears in search engine results. If
                                    left empty, product name will be used.</small>
                                <div class="mt-1">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('meta_description') is-invalid @enderror" id="meta_description"
                                    ...
                                    placeholder="Enter meta description for SEO (recommended: 150-160 characters)" maxlength="500">{{ old('meta_description') }}</textarea>
                                <small class="form-text text-muted">Brief description that appears in search engine
                                    results. If left empty, short description will be used.</small>
                                <div class="mt-1">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('meta_keywords') is-invalid @enderror"
                                    ...
                                    maxlength="500">
                                <small class="form-text text-muted">Comma-separated keywords relevant to this product for
                                    SEO purposes.</small>
                                <div class="mt-1">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('meta_tags') is-invalid @enderror"
                                    id="meta_tags" name="meta_tags" value="{{ old('meta_tags') }}"
                                    placeholder="e.g., premium, quality, elegant, stylish (comma-separated)"
                                    maxlength="500">
                                <small class="form-text text-muted">Additional tags for better categorization and SEO
                            ...
                            <div class="form-group">
                                ...
                                <small class="form-text text-muted">Upload main product image (JPG, PNG, GIF, WebP - Max:
                                    2MB). Images will be automatically converted to WebP format.</small>
                                @error('image')
                                    <span class="invalid-feedback d-block" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group">
                                ...
                                <small class="form-text text-muted">Upload multiple images (JPG, PNG, GIF, WebP - Max: 2MB
                                    each). Images will be automatically converted to WebP format.</small>
                                @error('images.*')
                                    <span class="invalid-feedback d-block" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group">
                                ...
                                <input type="file"
                                    ...
                                    id="size_guide_image" name="size_guide_image" accept="image/*">
                                <small class="form-text text-muted">Upload size guide image (JPG, PNG, GIF, WebP - Max:
                                    2MB). Image will be automatically converted to WebP format.</small>
                                ...
                                <div id="size-guide-preview" class="mt-3" style="display: none;">
                                    <img id="preview-size-guide-img" src="" alt="Size Guide Preview"
    ...
    <script>
        ...
        function updateSelectedCategories() {
            ...
            if (selectedCategories.length > 0) {
                selectedCategoriesDiv.innerHTML = '<strong>Selected Categories:</strong> ' + selectedCategories.join(', ');
                selectedCategoriesDiv.className = 'mt-2 text-success';
            } else {
                selectedCategoriesDiv.innerHTML = '<span class="text-danger">Please select at least one category</span>';
            }
        }
